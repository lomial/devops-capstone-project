...
This project implements a RESTful microservice for managing customer accounts. 
The service allows creating, reading, updating, deleting and listing customer accounts. 
The project uses Python Flask and will be containerized with Docker and deployed to Kubernetes.
